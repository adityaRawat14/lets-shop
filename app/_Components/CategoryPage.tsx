  ...
  return (
    <main className="flex w-screen  bg-slate-900 "  >
      ...
      {subCategories.map((subCat: string) => {
        ...
        return (
             <section id={subCat} className="border-[2px] rounded-lg overflow-x-auto  hide-scrollbar  border-gray-800  flex-grow h-[25rem]  shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px]  ">
            <div>
