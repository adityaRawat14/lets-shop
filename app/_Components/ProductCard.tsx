...
function ProductCard({product}:{product:any}) {
  ...
  return (
    ...
    //     <button className='px-2  border-[2px] border-green-600 text-green-900 rounded-[8px] flex justify-center items-center' onClick={()=>{handleAddToCart(product)}}>Add</button>
    //     </span>
